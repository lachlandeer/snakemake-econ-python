...
def partial_residuals_aug_cc(df):
    yp_reg_eq = "ln_gdp_growth ~  ln_inv_gdp + ln_ndg + ln_school"
    xp_reg_eq = "ln_gdp_60 ~  ln_inv_gdp + ln_ndg + ln_school"
...
def plot_cond_conv(partial_df, outfile):
    ...
    ax.plot(np.unique(df['x_partial']),
            ...
            color='r')
    ax.set_title("C: Conditional on Saving and Population Growth and Human Capital")
...
if __name__ == "__main__":
    ...
    partials = partial_residuals_aug_cc(mrw_subset)
